    ...
    <>
      ...
      >
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative" }}>
          <div style={{ maxWidth: "600px" }}>
            <p className="section-label" style={{ color: "var(--accent)" }}>Get In Touch</p>
            ...
            <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "1.05rem", lineHeight: 1.8 }}>
              Whether you have a clear vision or just a rough idea — reach out and we'll help you shape it into a plan. Consultations are always free.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "6rem 1.5rem", background: "var(--bg)" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: "5rem", alignItems: "start" }} className="contact-grid">
          {/* Left: info */}
          <div>
            <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "1.75rem", color: "var(--text)", marginBottom: "1.5rem" }}>
              Contact information
            </h2>
          ...
          <div className="bento-card" style={{ padding: "2.5rem" }}>
            {submitted ? (
              <div style={{ textAlign: "center", padding: "3rem 0" }}>
                ...
                <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.75rem", fontWeight: 700, color: "var(--text)", marginBottom: "0.75rem" }}>
                  Thank you, {form.name.split(" ")[0]}!
                </h3>
                <p style={{ color: "var(--text-muted)", lineHeight: 1.75, maxWidth: "400px", margin: "0 auto" }}>
                  We've received your enquiry and one of our renovation consultants will be in touch within 1 business day.
                </p>
              </div>
            ) : (
              <div>
                <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "1.5rem", color: "var(--text)", marginBottom: "0.5rem" }}>
                  Get your free consultation
                </h3>
                <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", marginBottom: "2rem" }}>
                  Fill in the form and we'll be in touch within 1 business day.
                </p>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
                  <div>
                    ...
                    <input
                      ...
                      style={{ width: "100%", padding: "0.75rem 1rem", border: "1.5px solid var(--border)", borderRadius: "8px", fontFamily: "var(--font-body)", fontSize: "0.9rem", background: "var(--bg)", outline: "none", transition: "border-color 0.2s" }}
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
                  ...
                  <div>
                    <label style={{ display: "block", fontSize: "0.8rem", fontWeight: 600, color: "var(--text)", marginBottom: "0.4rem" }}>Project Address</label>
                    <input
                      name="address"
                      value={form.address}
                      onChange={handleChange}
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
                  <div>
                    ...
                    <select
                      ...
                      value={form.service}
                      onChange={handleChange}
                      style={{ width: "100%", padding: "0.75rem 1rem", border: "1.5px solid var(--border)", borderRadius: "8px", fontFamily: "var(--font-body)", fontSize: "0.9rem", background: "var(--bg)", outline: "none" }}
                    >
                ...
                <div style={{ marginBottom: "1.5rem" }}>
                  ...
                  <textarea
                    ...
                    value={form.message}
                    onChange={handleChange}
                    placeholder="Describe your renovation vision, any specific requirements, or questions you have..."
                    rows={4}
                    style={{ width: "100%", padding: "0.75rem 1rem", border: "1.5px solid var(--border)", borderRadius: "8px", fontFamily: "var(--font-body)", fontSize: "0.9rem", background: "var(--bg)", outline: "none", resize: "vertical", transition: "border-color 0.2s" }}
                    onFocus={(e) => (e.target.style.borderColor = "var(--accent)")}
                    onBlur={(e) => (e.target.style.borderColor = "var(--border)")}
                  />
                </div>
                ...
                <p style={{ textAlign: "center", color: "var(--text-muted)", fontSize: "0.775rem", marginTop: "1rem" }}>
